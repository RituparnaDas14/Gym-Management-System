 ...
 */
public class InventoryEdit extends javax.swing.JInternalFrame {
           ...
           while(rs.next()) {
              ...
              jTextField4.setText(rs.getString(4));
               jTextField5.setText(rs.getString(5));
                  jTextField6.setText(String.valueOf(rs.getDate(6)));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      try {
        ...
        try {
          Connection con=Dbconnection.getConn();
             PreparedStatement ps=con.prepareStatement("update inventory set category=?,description=?,brand=?,quantity=?,date1=? where id=?");

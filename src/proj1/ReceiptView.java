...
public class ReceiptView extends javax.swing.JInternalFrame {

   
    public ReceiptView() {
        super("Receipt view",true,true,true,true);
        initComponents();
         try {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "date", "Lastname", "FirstName", "Amount Paid", "Payment for", "How Paid", "Received By"
            }
        ));
